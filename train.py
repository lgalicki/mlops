...
def read_data():
    data = pd.read_csv(
        ...
        '/master/fetal_health_reduced.csv')
...
def config_mlflow():
    MLFLOW_TRACKING_URI = 'https://dagshub.com/lgalicki/mlops.mlflow'
    MLFLOW_TRACKING_USERNAME = 'lgalicki'
    MLFLOW_TRACKING_PASSWORD = 'c846933fe7a425408303a0fb5da930aed1445ce4'
